...
var HeroSlider = (function () {
  function HeroSlider($params, $selector) {
...
function imageBackground() {
  var imageSelector = document.querySelectorAll('.image-bg');

  if (imageSelector.length) {
    imageSelector.forEach(function (el) {
      var imageBg = el.querySelector('img');
      var imageSrc = imageBg.src;
...
function scrollAddClass() {
  ...
  var add_class_on_scroll = function add_class_on_scroll() {
    return header.classList.add("navbar--scrolled");
  };
  var remove_class_on_scroll = function remove_class_on_scroll() {
    return header.classList.remove("navbar--scrolled");
  };
